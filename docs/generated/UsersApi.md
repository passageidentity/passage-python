...
> ListPaginatedUsersResponse list_paginated_users(app_id, page=page, limit=limit, created_before=created_before, order_by=order_by, identifier=identifier, id=id, login_count=login_count, status=status, created_at=created_at, updated_at=updated_at, last_login_at=last_login_at)
...
with passageidentity.openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List Users
        api_response = api_instance.list_paginated_users(app_id, page=page, limit=limit, created_before=created_before, order_by=order_by, identifier=identifier, id=id, login_count=login_count, status=status, created_at=created_at, updated_at=updated_at, last_login_at=last_login_at)
