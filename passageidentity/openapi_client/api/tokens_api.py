...
class TokensApi:
    ...
    def revoke_user_refresh_tokens(
        ...
        _param = self._revoke_user_refresh_tokens_serialize(
            app_id=app_id,
            user_id=user_id,
    ...
    @validate_call
    def revoke_user_refresh_tokens_with_http_info(
        self,
        app_id: Annotated[StrictStr, Field(description="App ID")],
        user_id: Annotated[StrictStr, Field(description="User ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def revoke_user_refresh_tokens_without_preload_content(
        self,
        app_id: Annotated[StrictStr, Field(description="App ID")],
        user_id: Annotated[StrictStr, Field(description="User ID")],
        _request_timeout: Union[
    ...
    def _revoke_user_refresh_tokens_serialize(
        self,
        app_id,
        user_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/apps/{app_id}/users/{user_id}/tokens',
