...
class UsersApi:
    ...
    def list_paginated_users(
        ...
        email_verified: Annotated[Optional[StrictBool], Field(description="search users email_verified (pagination prepended operators email_verified=<val>, email_verified=<ne:val>, email_verified=<gt:val>, email_verified=<lt:val>)")] = None,
        ...
        :type status: str
        :param email_verified: search users email_verified (pagination prepended operators email_verified=<val>, email_verified=<ne:val>, email_verified=<gt:val>, email_verified=<lt:val>)
