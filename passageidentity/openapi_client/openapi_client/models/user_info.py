...
class UserInfo(BaseModel):
    ...
    recent_events: List[UserEventInfo1]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "recent_events": [UserEventInfo1.from_dict(_item) for _item in obj.get("recent_events")] if obj.get("recent_events") is not None else None,
